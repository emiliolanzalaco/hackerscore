...
export const HACKER_SCORE_RESOLVER_ABI = [
  {
    inputs: [{ internalType: 'address', name: 'eas_', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  { inputs: [], type: 'error', name: 'InvalidSchemaUID' },
